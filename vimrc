...
" Make Ctrl-Up/-Down increase/decrease folding for buffer:
nmap <expr> <C-Up> &foldlevel == 99 ? "zMzRzz" : "zmzz"
...
" Add motions for next and previous text objects
" For example, "din(" would go to the next "()" pair and delete its contents.
" (Thank you, Steve Losh!)
" (https://news.ycombinator.com/item?id=3122084)
